...
const Most = () => {
    ...
    return (
        <div className="my-24 max-w-screen-xl mx-auto">
            <h1 className="md:text-3xl text-xl text-white  font-cinzel font-semibold text-center">Most Read Blogs</h1>
            <h1 className='text-center font-cinzel text-white font-bold my-3 text-sm md:text-xl'>
            Discover What’s Capturing Attention</h1>
            <div className="grid p-3 grid-cols-1 md:grid-cols-3 gap-6 mt-6">
                {
                    most.map(b => (
