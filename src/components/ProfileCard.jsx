...
const ProfileCard = () => {
  return (
    <div className="mt-12 max-w-screen-xl mx-auto">
      <h1 className="text-center text-white font-cinzel text-2xl font-bold">T<span className="underline">e</span>a<span className="underline">m</span>s</h1>
      <div className="mb-12 grid p-3 grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="w-full border-2 px-8 py-4 mt-16  rounded-lg shadow-xl dark:bg-gray-800">
          ...
          <div className="mt-4 text-center md:text-left">
            <h2 className="text-xl font-semibold text-white dark:text-white">Jonathan Doe</h2>
            <p className="text-sm text-white dark:text-gray-200">Collaborator & Editor</p>
        ...
        <div className="w-full border-2 px-8 py-4 mt-16  rounded-lg shadow-xl dark:bg-gray-800">
          ...
          <div className="mt-4 text-center md:text-left">
            <h2 className="text-xl font-semibold text-white dark:text-white">Jane Smith</h2>
            <p className="text-sm text-white dark:text-gray-200">Content Writer</p>
            <p className="mt-2 text-white dark:text-gray-200">
        ...
        <div className="w-full border-2 px-8 py-4 mt-16  rounded-lg shadow-xl dark:bg-gray-800">
          ...
          <div className="mt-4 text-center md:text-left">
            <h2 className="text-xl font-semibold text-white dark:text-white">Alex Brown</h2>
            <p className="text-sm text-white dark:text-gray-200">Graphic Designer</p>
            <p className="mt-2 text-white dark:text-gray-200">
