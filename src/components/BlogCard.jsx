...
const BlogCard = ({ b }) => {
    ...
    return (
        <div className="border-white border-2 rounded-lg shadow-lg overflow-hidden">
            <img className="object-cover w-full h-48 md:h-56 lg:h-64" src={image} alt="" />
            <div className="p-6">
                <div className="flex justify-between">
                    <p className="text-sm bg-white/15 p-2 rounded-lg text-blue-500 uppercase">{category}</p>
                    <p className="text-sm bg-white/15 p-2 rounded-lg text-blue-500 uppercase">{date}</p>
                </div>
                <Link to={`/blog/${_id}`} className="block mt-2 text-xl font-semibold text-white dark:text-white">
                    {title}
                </Link>
                ...
                <div className="flex items-center justify-between">
                    ...
                    <p className="text-sm bg-white/15 p-2 rounded-lg text-blue-500 ">{time_to_read} <span className="ml-1">Minutes To Read</span></p>
                </div>
                <div className="flex justify-between items-center">
                    <div className="flex items-center mt-4">
                        ...
                        <div className="ml-4">
                            ...
                            <p className="text-sm text-white dark:text-gray-400">Researcher</p>
                        </div>
                    </div>
                    <div className="flex items-center justify-between lg:gap-2 gap-1 mt-4">
                        <button className="p-3 hover:btn rounded-lg text-sm bg-white/15 text-blue-500" onClick={handleSaveClick}>
