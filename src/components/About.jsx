...
const About = () => {
  return (
    <div className="font-cinzel text-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="text-4xl text-center font-bold text-white mb-8">Welcome to Mindful Mosaic</h1>
        <div className="flex justify-center mb-8">
          <img 
            src={img} 
            alt="Mindful Mosaic Hero" 
            className="w-full h-auto object-cover border-2 rounded-lg shadow-lg"
          />
        </div>
        ...
        <h2 className="text-3xl text-center font-semibold text-white mb-4">What We Cover</h2>
        <div className="space-y-6 mb-8">
          ...
          <div className="flex items-center space-x-4 mb-6">
            ...
            />
            <div>
              <h3 className="text-2xl font-semibold text-white">Health and Wellness</h3>
              <p className="text-lg text-white">
          ...
          <div className="flex items-center space-x-4 mb-6">
            ...
            />
            <div>
              <h3 className="text-2xl font-semibold text-white">Travel and Adventure</h3>
              <p className="text-lg text-white">
          ...
          <div className="flex items-center space-x-4 mb-6">
            ...
            />
            <div>
              <h3 className="text-2xl font-semibold text-white">Lifestyle and Culture</h3>
              <p className="text-lg text-white">
          ...
          <div className="flex items-center space-x-4 mb-6">
            ...
            />
            <div>
              <h3 className="text-2xl font-semibold text-white">Environment and Sustainability</h3>
              <p className="text-lg text-white">
          ...
          <div className="flex items-center space-x-4 mb-6">
            ...
            />
            <div>
              <h3 className="text-2xl font-semibold text-white">Personal Development</h3>
              <p className="text-lg text-white">
          ...
          <div className="flex items-center space-x-4 mb-6">
            ...
            />
            <div>
              <h3 className="text-2xl font-semibold text-white">Creative Expressions</h3>
              <p className="text-lg text-white">
        ...
        <h2 className="text-3xl text-center font-semibold text-white mb-4">Join the Conversation</h2>
        <p className="text-lg text-white mb-8">
        ...
        <h2 className="text-3xl text-center font-semibold text-white mb-4">Stay Connected</h2>
        <p className="text-lg text-white mb-8">
